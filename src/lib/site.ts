 ...
 *
 * Must be https://www.anytap.io while apex (anytap.io) is GoDaddy forwarding:
 * only `/` 301s to www; `/favicon.ico`, `/assets/*`, OG images, and other
 * paths 404. Google indexes the canonical host and then fetches those URLs,
 * which is why search results show a broken favicon / broken preview images.
 * After apex DNS points at Amplify, this can switch back to https://anytap.io.
 */
export const SITE_ORIGIN = 'https://www.anytap.io';
