...
export const changePassword = auth.changePassword ?? (async () => ({ ok: true }));
export const sendForgotPasswordEmail = auth.sendForgotPasswordEmail ?? (async () => ({ ok: true }));
export const resetPassword = auth.resetPassword ?? (async () => ({ ok: true }));
